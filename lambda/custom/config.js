    ...
    languageString: {
        "fr-FR": {
            translation: {
                ...
                "Mais le service est temporairement indisponible. Nous vous demandons de réessayer plus tard. ", 
                "Cependant le service est actuellement indisponible. Veuillez réessayer plus tard. "],
                ASK_OTHER_ACTION: ["Souhaitez vous faire autre chose avec notre application? ", "Désirez vous effectuer une autre action ? ", 
